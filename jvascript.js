...
searchBtn.addEventListener('click', function(){
  fetch(`http://api.weatherapi.com/v1/current.json?key=8cced427c682481685b222916231703&q=${input.value} &aqi=no`)
  .then(res=>res.json())
  .then(data=>{console.log(data)
    ...
    document.body.style.backgroundImage="url('https://source.unsplash.com/1600x900/?" +locationCity+"')"
